...
function Nav() {
  ...
  return (
    <div className="w-full sticky top-0 z-50 bg-gradient-to-br from-[#FFCDA2] to-[#FFAF68] px-2 md:px-6 py-2 flex flex-col md:flex-row items-center justify-between space-y-2 md:space-y-0">
      ...
      {/* Search Bar */}
      <form
        className="w-full md:w-[40%] h-[44px] bg-white flex items-center px-3 gap-2 rounded-md shadow-md"
        onSubmit={e => e.preventDefault()}
      >
        <IoMdSearch className="text-[#F47200] w-5 h-5" />
        <input
          type="text"
      ...
      <div className="flex items-center gap-3 text-white text-sm">
        <Link to="/aboutus" className="relative text-white px-4 py-4  rounded-full transition duration-300 hover:after:w-[35px] after:absolute after:left-4 after:bottom-2 after:h-[2px] after:w-0 after:bg-white after:transition-all after:duration-300 font-semibold ">
          About Us
        </Link>
        <Link to="/login" className="relative text-white px-4 py-4  rounded-full transition duration-300 hover:after:w-[35px] after:absolute after:left-4 after:bottom-2 after:h-[2px] after:w-0 after:bg-white after:transition-all after:duration-300 font-semibold ">
          Login
        </Link>
        <div className="w-[60px] h-[60px]  flex justify-center items-center rounded-md  relative " onClick={()=>{
        setShowCart(true)
      }}>
...
//   return(
//     <div className="w-full flex flex-col md:flex-row items-center justify-between px-2 md:px-8 py-1 md:h-[100px] sticky top-0 z-50 bg-gradient-to-br from-[#FFCDA2] to-[#FFAF68] space-y-2 md:space-y-0">
